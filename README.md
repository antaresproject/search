...
Antares Search changelog can be found in release notes [antaresproject.io/docs/site/getting_started/changelog/#search](http://antaresproject.io/docs/site/getting_started/changelog/index.html#search).
